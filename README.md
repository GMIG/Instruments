# Инструменты
Инструменты - это программно-образовательная платформа, которая позволит музеям использовать мощь бесплатного программного обеспечения для того чтобы делать мультимедийные и интерактивные объекты
...
Если монитор у вас старый и разъем у него VGA <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/SVGA_port.jpg/1200px-SVGA_port.jpg" height="100">, то кроме провода micro HDMI-HDMI вам понадобится переходник hdmi-VGA. Все это можно купить в том же магазине.
